            ...
            <section id="contact" className="contact mt-5 mb-5">
                ...
                <div>
                    <div className="container">
                        ...
                        <iframe style={{ border: 0, width: "100%", height: "350px" }} src="https://www.google.com/maps/d/embed?mid=1zzEulSUGWyByrvzQNMenJh4mGuo&hl=en_US&ehb" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
            </section>
            <Footer />
