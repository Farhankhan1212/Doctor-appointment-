...
const Blog = () => {
    ...
    return (
        <>
            <Header />
            <SubHeader title='Blog' subtitle='This blog from Mindster discusses how doctor appointment apps can help provide efficient healthcare services and eliminate long lines..' />
