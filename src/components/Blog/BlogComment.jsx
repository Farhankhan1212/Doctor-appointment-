                ...
                Array(4).fill(null).map((_item, index) => (
                    <div className='d-flex gap-3 mb-3' key={index + 5}>
                        ...
                        <div>
                            <div className='mb-2'>
                                <h6>SAHIL </h6>
                                <p className='form-text mb-0'>APRIL 2024</p>
                            </div>
                            <p className='form-text'>
                            This blog from Mindster discusses how doctor appointment apps can help provide efficient healthcare services and eliminate long lines.
                            </p>
                        </div>
                    </div>
                ))
