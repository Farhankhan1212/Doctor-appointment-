                            ...
                            <div className="col-md-6">
                                <div className="invoice-info">
                                    ...
                                    <p className="invoice-details invoice-details-two">
                                        Dr. {data?.appointment?.doctor?.firstName ? `${data?.appointment?.doctor?.firstName} ${data?.appointment?.doctor?.lastName}`: ' Of DoctorCall'} <br />
                                        {data?.appointment?.doctor?.address ? data?.appointment?.doctor?.address : "GOMTI NAGAR, LUCKNOW ,226028"}, {data?.appointment?.doctor?.city && data?.appointment?.doctor?.city},<br />
