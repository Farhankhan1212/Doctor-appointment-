                ...
                <div className="row">
                    <div className="col-lg-4 d-flex align-items-stretch">
                        <div className="content">
                            <h3>Why Choose Us?</h3>
                            <p>
                            You take away the pain and sufferings of others by giving them medical treatment and healthcare.
                            </p>
                            ...
                            <div className="row">
                                <div className="col-xl-4 d-flex align-items-stretch">
                                    <div className="icon-box mt-4 mt-xl-0">
                                        ...
                                        <p>An ISO/IEC 27001 certified app that connects you with doctors via video or on-call</p>
                                    </div>
                                </div>
                                <div className="col-xl-4 d-flex align-items-stretch">
                                    <div className="icon-box mt-4 mt-xl-0">
                                        ...
                                        <h6 className='text-secondary'>+91 7800629106</h6>
                                        <p>HealthApp is a telemedicine app that offers online consultations from doctors, medical advice, and prescription services. It connects users with specialist doctors via video call or chat, allowing users to access healthcare services from home.</p>
                                    </div>
                                </div>
                                <div className="col-xl-4 d-flex align-items-stretch">
                                    <div className="icon-box mt-4 mt-xl-0">
