...
const BookDoctor = () => {
	const { data, isError, isLoading } = useGetDoctorsQuery({ limit: 1 });
						...
						<div className="profile-widget">
							...
							<div className="pro-content">
								...
								<ul className="available-info">
									<li>
										<FaLocationArrow className='icon' /> lucknow
									</li>
									<li>
				...
				<div className="row">
					<div className="col-12 col-md-3 col-lg-3">
						<div className='mb-2 section-title text-center'>
							...
							<p className='m-0 text-secondary'>BEST DOCTORS</p>
						</div>
						<div className="form-text">
							<p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using.</p>
							<p>as their default model text</p>
